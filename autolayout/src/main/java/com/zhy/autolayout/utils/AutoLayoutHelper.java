...
public class AutoLayoutHelper
{
    ...
    private static final int INDEX_DRAWABLELEFT=17;
    private static final int INDEX_DRAWABLERIGHT=18;
    private static final int INDEX_DRAWABLETOP=19;
    private static final int INDEX_DRAWABLEBOTTOM=20;
...
//            if (!isPxVal(val)) continue;
            ...
            switch (index)
            {
                ...
                case INDEX_MIN_HEIGHT:
                    ...
                    break;
                case INDEX_DRAWABLELEFT:
                case INDEX_DRAWABLERIGHT:
                case INDEX_DRAWABLETOP:
                case INDEX_DRAWABLEBOTTOM:
